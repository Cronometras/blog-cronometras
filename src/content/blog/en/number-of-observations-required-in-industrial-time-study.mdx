...
<WebpImage src="/images/default.png" alt="Table establishing the number of readings according to the duration of the cycle to be timed" />
...
<WebpImage src="/images/default.png" alt="ILO formula to calculate the number of observations" />
