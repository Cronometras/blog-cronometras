...
<WebpImage src="/images/webp/default.webp" alt="Table establishing the number of readings according to the duration of the cycle to be timed" />
...
<WebpImage src="/images/webp/default.webp" alt="ILO formula to calculate the number of observations" />
