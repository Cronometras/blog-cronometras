<?php
// Endpoint for contact form without trailing slash
...
error_log("Contact API endpoint (no slash) called with method: " . $_SERVER['REQUEST_METHOD']);
...
try {
    ...
    // Debug log
    error_log("Contact form data: name=$name, email=$email, subject=$subject, message=$message");
