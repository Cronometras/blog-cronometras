...
function updateBlogImageReferences() {
  ...
  blogFiles.forEach(filePath => {
    ...
    while ((match = heroImageRegex.exec(content)) !== null) {
      ...
      updatedReferences++;
      console.log(`  - Actualizada heroImage en ${path.basename(filePath)}:`);
    ...
    while ((match = markdownImageRegex.exec(content)) !== null) {
      ...
      if (imagePath.endsWith('.webp')) {
        ...
        fileUpdatedReferences++;
        updatedReferences++;
        console.log(`  - Actualizada imagen Markdown en ${path.basename(filePath)}:`);
        console.log(`    De: ${imagePath}`);
        console.log(`    A:  ${newImagePath}`);
      } else {
        // La imagen no está en formato WebP, necesitamos convertirla
    ...
    while ((match = htmlImageRegex.exec(content)) !== null) {
      ...
      if (imagePath.endsWith('.webp')) {
        ...
        fileUpdatedReferences++;
        updatedReferences++;
        console.log(`  - Actualizada imagen HTML en ${path.basename(filePath)}:`);
        console.log(`    De: ${imagePath}`);
        console.log(`    A:  ${newImagePath}`);
      } else {
        // La imagen no está en formato WebP, necesitamos convertirla
