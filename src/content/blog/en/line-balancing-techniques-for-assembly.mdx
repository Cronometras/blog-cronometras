...
Yes. While the initial analysis takes longer than a simple stopwatch study, the resulting standards are more robust and reusable, leading to a clear reduction in "hidden" inefficiencies.
