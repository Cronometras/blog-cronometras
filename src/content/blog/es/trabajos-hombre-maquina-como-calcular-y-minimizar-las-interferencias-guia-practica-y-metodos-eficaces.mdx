...
author: "micaot"
heroImage: "/images/webp/hombre trabajando en 2 máquinas.webp"
---
...
<pre><code>I=50*[√(1+x)^2+2*(N-1)*(1+x)-2*(N-1)-1]</code></pre>
...
<WebpImage src="/images/default.png" alt="Curva empírica para el cálculo de interferencia (Niebel B. W. y col.)" />
