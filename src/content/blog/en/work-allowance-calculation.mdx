...
- There are four main types: personal needs allowances, basic fatigue allowances, variable fatigue allowances (based on conditions), and unavoidable delay allowances.
...
There are four main types: personal needs allowances (to cover physiological breaks), basic fatigue allowances (constant), variable fatigue allowances (based on factors such as physical effort, posture, and environmental conditions), and unavoidable delay allowances (determined through work sampling). The final calculation adds all these percentages and applies them to the basic time: ST = BT × (1 + % Total Allowance / 100).
...
- **Determination:** Established as a fixed percentage of work time, according to the applicable policy or agreement.

##### 2. Fatigue Allowances

- **Basic Fatigue:** A constant percentage applied to almost all tasks to compensate for the energy expenditure inherent to being alive and working.
