...
<figure>
<figure>![Save percentage of rest coefficients](/images/webp/og-default.png)<figcaption>Save percentage of rest coefficients</figcaption></figure>

<figure>![edit the points assigned for calculating the rest coefficient in 1 factor of the supplement tables](/images/webp/og-default.png)<figcaption>edit the points assigned for calculating the rest coefficient in 1 factor of the supplement tables</figcaption></figure>

<figure>![list of weights for factor A1, in the ILO supplement tables](/images/webp/og-default.png)<figcaption>list of weights for factor A1, in the ILO supplement tables</figcaption></figure>
</figure>
