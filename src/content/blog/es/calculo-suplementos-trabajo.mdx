...
- Existen cuatro tipos principales: por necesidades personales, por fatiga básica, por fatiga variable (según condiciones) y por retrasos inevitables.
...
- **Determinación:** Se establece como un porcentaje fijo del tiempo de trabajo, según la política o el acuerdo aplicable.

##### 2. Suplementos por Fatiga

- **Fatiga Básica:** Es un porcentaje constante que se aplica a casi todas las tareas para compensar el gasto energético inherente a estar vivo y trabajando.
