...
Rest coefficients (K Allowances) have traditionally been applied in this sector. However, the chemical environment presents aggressive conditions that new ILO tables penalize severely:
