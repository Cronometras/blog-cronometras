<?php
// Test script for form submissions with Spanish field names
...
echo "<h1>Test de Formularios (Campos en Español)</h1>";
...
echo "<h2>{$form['name']} (Campos en Español)</h2>";
...
echo "<p>Este script te permite probar los formularios con nombres de campos en español, tal como los envían los componentes React.</p>";
