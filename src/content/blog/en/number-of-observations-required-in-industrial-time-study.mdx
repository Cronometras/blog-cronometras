...
![Table establishing the number of readings according to the duration of the cycle to be timed](/images/default.png)
...
![ILO formula to calculate the number of observations](/images/default.png)
