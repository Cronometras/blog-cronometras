...
It is calculated via valuation tables scoring factors such as force exerted, posture, vibration, and environmental conditions. These points convert to a percentage added to the base rest coefficient and personal needs.
