...
// Función para comentar las importaciones de WebpImage en los archivos MDX
function commentWebpImageImports() {
  ...
  mdxFiles.forEach(filePath => {
    ...
    // Buscar importaciones de WebpImage
    const importRegex = /import\s+WebpImage\s+from\s+['"]@components\/WebpImage\.astro['"];/g;
    
    // Comentar las importaciones de WebpImage
